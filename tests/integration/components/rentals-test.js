...
module('Integration | Component | rentals', function (hooks) {
  ...
  test('search is case insensitive', async function (assert) {
    await render(hbs`<Rentals @rentals={{this.rentals}} />`);
    await fillIn('.rentals input', 'down');
  ...
  test('search includes city', async function (assert) {
    await render(hbs`<Rentals @rentals={{this.rentals}} />`);
  ...
  test('search includes category', async function (assert) {
    await render(hbs`<Rentals @rentals={{this.rentals}} />`);
  ...
  test('search includes description', async function (assert) {
    await render(hbs`<Rentals @rentals={{this.rentals}} />`);
    await fillIn('.rentals input', 'charming');
  ...
  test('search includes type', async function (assert) {
    await render(hbs`<Rentals @rentals={{this.rentals}} />`);
